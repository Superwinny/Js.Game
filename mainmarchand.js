...
// Fonction pour acheter un item du marchand
function acheterItem(nomItem) {
  ...
  if (hero) {
    ...
    const classe = hero.constructor.name;
    ...
    if (magasin.hasOwnProperty(nomItem)) {
      ...
      if (hero.gold >= item.prix) {
        ...
        // Afficher les informations mises à jour du héros
        hero.afficher(
          document.getElementById("ptn-vie"),
          document.getElementById("potion-soin-hero"),
          document.getElementById("arme"),
